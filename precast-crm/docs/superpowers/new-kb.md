...
> ℹ️ **Note:** Conversation style, voice, and example dialogue now live in the system prompt. This document is FACTS ONLY — product reference, standards, dimensions, pricing mechanics, and policy. Every price, quantity, stock level and delivery figure must come from a tool call, never from this text.
...
- **Can only two people handle or carry the beams? (Balkasini 2kishi ko'tara oladimi?**→ Ikki kishi sal qiynaladi, 1m balka 32kg chiqadi
