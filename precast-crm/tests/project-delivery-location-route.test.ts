...
import { DeliveryLocationBody } from "@/app/api/projects/[id]/delivery-location/schema";

describe("Project DeliveryLocationBody schema", () => {
  it("accepts a full pin with url and label (set)", () => {
